    ...
    <section className="relative min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-white py-12 px-4 lg:py-20 lg:px-8">
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          {/* Left Side - Form */}
          <div className="bg-gradient-to-br from-indigo-950 to-purple-900 rounded-3xl p-6 lg:p-10 shadow-2xl">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-transparent border-b-2 border-white/50 focus:border-white text-white placeholder-white/60 py-2 px-1 outline-none transition-colors"
                  />
                </div>
              ...
              <div className="flex justify-end pt-4">
                <button
                  ...
                  className="bg-white cursor-pointer text-purple-900 px-8 py-3 rounded-full font-semibold flex items-center gap-2 hover:bg-purple-50 transition-colors shadow-lg hover:shadow-xl"
                >
                  Next
              ...
              <div className="bg-white relative rounded-2xl shadow-xl  hover:shadow-2xl transition-shadow h-full flex flex-col">
                ...
                <div className="p-4 text-center ">
                  ...
                  <p className="text-xs text-gray-600 mb-3">Effortless iOS App Distribution</p>
                    <button className="bg-purple-700 absolute left-1/2 -translate-x-1/2 -bottom-3   text-white text-xs px-4 py-2 rounded-full hover:bg-purple-800 transition-colors">
                    Read more
                  </button>
                </div>
              </div>
