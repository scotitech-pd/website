  ...
  return (
    <section className="relative bg-white text-black overflow-hidden pt-20 px-8 sm:px-0">
      ...
      <div className="max-w-8xl mx-auto  ">
        {/* Content wrapper */}
        <div className="grid md:grid-cols-2 gap-10 items-center text-center px-10">
          {/* Left Content */}
          <div>
        ...
        {/* Cards */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-10 md:gap-20 w-[87%]">
          {cards.map((card, index) => (
            ...
            >
              ...
              <p className="mt-12 text-[15px] text-center text-white font-lora leading-relaxed">
                {card.text}
              </p>
            </div>
          ))}
