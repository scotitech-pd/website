...
const OurStory = () => {
  return (
    <section className="relative bg-white text-black overflow-hidden pt-20 px-8 md:px-16">
      {/* Background shape */}
      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 items-center text-center">
        ...
        <div className="relative">
          ...
          />
          <div className="absolute -top-10 left-1/2 -translate-x-1/2 bg-white shadow-lg rounded-xl px-6 py-4 w-[90%] md:w-[80%] text-center border border-purple-100">
      ...
      {/* Cards */}
      <div className="mt-20 grid grid-cols-1 md:grid-cols-4 gap-20 w-[80%] mx-auto">
        {cards.map((card, index) => (
          <div
            key={index}
            className="bg-main-dark text-white/80 rounded-2xl shadow-lg py-6 px-4 relative"
          >
            <div className="absolute top-4 w-[90%] text-center -right-10 bg-white text-main font-semibold rounded-full px-5 py-2 shadow-[0_0_25px_rgba(128,128,128,0.9)]">
              {card.title}
            </div>
