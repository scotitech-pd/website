...
export default function UnlockSection() {
  return (
    <section
      className="relative flex items-center justify-between px-10 md:px-20 bg-cover bg-center text-white overflow-hidden"
      style={{
        backgroundImage: "url('/images/home/unlockbg.png')", // replace with your image path
      }}
    >
        <img src="/images/home/Rectangle.png" alt="bg"  className="absolute bottom-0 h-full right-0"/>
      {/* Overlay */}
      ...
      <div className="relative z-10  py-24">
        ...
        <p className="text-gray-300 mb-4 text-sm leading-relaxed">
          ...
          operational hurdles. ScotiTech provides the tools to make that happen.
          Our lean, scalable solutions streamline everything from app deployment
          to content creation, reducing costs and unlocking new levels of
      ...
      {/* Right Stats */}
      <div className=" z-10 !bg-white h-full w-[100%] block">
        <StatCircle
          number="15+"
