...
export default function HowToGetElderConnect() {
  ...
  return (
    <section className="bg-white py-20">
      <div className="max-w-7xl mx-auto px-6 md:px-12 xl:px-0 grid md:grid-cols-2 gap-12 items-center  font-lora">
        {/* LEFT SIDE */}
        <div>
          ...
          <p className="text-[#4E4E4E] text-xl mb-5">
            Getting started with Elder Connect is simple and <br /> takes just a
            few minutes.
          </p>
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            {steps.map((step) => (
              ...
              >
                ...
                <p className="text-[#3B3B3B] leading-[22px]">{step.text}</p>
              </div>
            ))}
          </div>
        </div>
