export default function ElderConnectHero() {
  return (
    <section
      className="relative overflow-hidden text-white py-19 min-[1380px]:py-27 bg-cover bg-center "
      style={{
    ...
    >
      <div className="relative max-w-7xl mx-auto px-16 min-[1380px]:px-6 flex flex-col lg:flex-row items-center justify-between gap-12">
        <div className="lg:w-2/3 space-y-6">
          <div className="text-5xl font-semibold relative w-fit font-karla">
            Elder Connect+
            <p className="absolute text-[85px] opacity-5 top-1/2 -translate-y-1/2 -left-5 text-nowrap">
              Elder Connect+
            </p>
          </div>

          <h2 className="text-2xl md:text-3xl font-medium font-karla mt-7">
            Connecting Generations. Supporting Independence. Providing Peace of
            Mind.
          </h2>
        ...
        <div className="lg:w-1/3 flex justify-center items-center relative">
          <img
            ...
            alt=""
            className="w-[80%] min-[1380px]:max-h-[500px]"
          />
        </div>
      </div>
    </section>
    ...
    >
      <div className="container mx-auto px-6 md:px-12 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="text-white relative z-10">
          ...
          <h3 className="text-xl md:text-2xl font-semibold mb-6"></h3>
          <p className="text-gray-200 leading-relaxed mb-8 max-w-lg"></p>
          <button className="bg-white text-gray-900 font-semibold px-6 py-3 rounded-lg shadow hover:bg-gray-100 transition-all"></button>
        </div>
