  ...
  return (
    ...
    >
      ...
      <div className="relative rounded-2xl p-[1.5px] bg-gradient-to-br from-[#98F9FF]/70 via-[#EABFFF]/70 to-main-light/90 shadow-lg">
        <div className="relative z-10  px-6 py-16 bg-black/60 text-center rounded-2xl border border-white/20 backdrop-blur-3xl shadow-2xl">
          ...
          <p className="text-md md:text-xl text-gray-50 leading-relaxed font-lora">
