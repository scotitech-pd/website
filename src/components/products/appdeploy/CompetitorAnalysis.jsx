      ...
      <div className="max-w-8xl mx-auto px-5 min-[500px]:px-10 md:px-20">
        ...
        <div className="hidden lg:block overflow-x-auto shadow-lg rounded-2xl border border-gray-200">
          <table className="min-w-full text-left text-sm md:text-base border-collapse font-lora">
            <thead>
              <tr className="bg-gradient-to-r from-[#3D297A] to-[#7E1A8E] text-white">
            ...
            <tbody>
              {data.map((row, i) => (
                ...
                >
                  ...
                  <td className="px-6 py-5 bg-[#F5EDFF] border-l-4 border-[#7E1A8E] text-[#1A1A1A] font-medium border-r border-gray-200">
                    {row.appdeploy}
                  </td>

                  <td className="px-6 py-5 text-[#6B7280] border-r border-gray-200">
                    {row.applivery}
                  </td>
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 bg-gray-50 rounded-md border-l-4 border-[#406E8F]/50">
                  <p className="text-[#406E8F] font-semibold mb-1 font-karla">Applivery</p>
