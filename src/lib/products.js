...
export const products = {
  appdeploy: {
      ...
      plans: [
        ...
        },
        {
          ...
          features: [
            ...
            "Contractual SLA with service credits, negotiated against the published 99.9% SLO",
    ...
    faqs: [
      ...
      { q: "Apple Business now includes a free MDM layer. Why do I still need AppDeploy?", a: "Use it — for a small team with a simple Apple-only fleet, it is genuinely enough, and it is the foundation AppDeploy builds on. What it doesn't give you is the operational layer: a branded portal your employees recognise, entitlement-led access, Release Guard preflight, rollout rings, per-device deployment answers, Evidence Packs, and an org-scoped audit trail. We are not competing with Apple — AppDeploy is the control layer for teams who have outgrown the free tier but are not ready for a full MDM platform either." },
